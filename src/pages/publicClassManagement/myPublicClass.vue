  ...
  <div>
    ...
    <el-dialog title="预定" :visible.sync="visible">
      ...
      <span slot="footer" class="dialog-footer">
          <el-button @click="editCancel('myForm')">取 消</el-button>
          <el-button type="primary" @click="editSure('myForm')">确 定</el-button>
        </span>
    </el-dialog>
  </div>
</template>
